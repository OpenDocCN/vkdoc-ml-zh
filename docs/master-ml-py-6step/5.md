...
![img/434293_2_En_5_Fig1_HTML.jpg](img/434293_2_En_5_Fig1_HTML.jpg)
...
| 。文件 | 反词 | [`www.winfield.demon.nl/`](http://www.winfield.demon.nl/) |
| 。文档 | Python-docx | [`https://python-docx.readthedocs.io/en/latest/`](https://python-docx.readthedocs.io/en/latest/) |
| 。电子书 | 电子书 | [`https://github.com/aerkalov/ebooklib`](https://github.com/aerkalov/ebooklib) |
| 。gif /.jpg /。jpeg /。png /。tiff /。tif(基准) | tessera CT ocr | [`https://github.com/tesseract-ocr`](https://github.com/tesseract-ocr) |
| 。html /。html 文件的后缀 | Beautifulsoup4 | [`http://beautiful-soup-4.readthedocs.io/en/latest/`](http://beautiful-soup-4.readthedocs.io/en/latest/) |
| . mp3 / .ogg / .wav 档案 | 演讲识别和 sox | URL 1:URL 2: [`http://sox.sourceforge.net/`](http://sox.sourceforge.net/) |
| 。味精 | 味精提取器 | [`https://github.com/mattgwwalker/msg-extractor`](https://github.com/mattgwwalker/msg-extractor) |
...
| 。附 | Python-pptx | [`https://python-pptx.readthedocs.io/en/latest/`](https://python-pptx.readthedocs.io/en/latest/) |
| 。著名图象处理软件 | PS2 文本 | [`http://pages.cs.wisc.edu/~ghost/doc/pstotext.htm`](http://pages.cs.wisc.edu/%257Eghost/doc/pstotext.htm) |
| 。普适文本格式 | Unrtf | [`www.gnu.org/software/unrtf/`](http://www.gnu.org/software/unrtf/) |
| . xlsx / .xls 档 | xlrd . xlrd . xlrd . xlrd . xlrd . xlrd . xlrd . xlrd . xlrd | [`https://pypi.python.org/pypi/xlrd`](https://pypi.python.org/pypi/xlrd) |
...
![img/434293_2_En_5_Fig2_HTML.jpg](img/434293_2_En_5_Fig2_HTML.jpg)
...
![img/434293_2_En_5_Figa_HTML.jpg](img/434293_2_En_5_Figa_HTML.jpg)
...
![img/434293_2_En_5_Fig3_HTML.jpg](img/434293_2_En_5_Fig3_HTML.jpg)
...
![img/434293_2_En_5_Fig4_HTML.jpg](img/434293_2_En_5_Fig4_HTML.jpg)
...
TF (term) = ![$$ \frac{Number\ of\ times\ term\ appears\ in\ a\ document}{Total\ number\ of\ term s\ in\ the\ document} $$](img/434293_2_En_5_Chapter_TeX_IEq1.png)

例如，考虑包含 100 个单词的文档，其中单词“ML”出现三次，则 TF (ML) = 3 / 100 = 0.03

文档频率会告诉你一个术语有多重要。

DF (term) = ![$$ \frac{d\ \left( number\ of\ documents\ containing\ a\  given\ term\right)}{D\ \left( the\ size\ of\ the\ collection\ of\ documents\right)} $$](img/434293_2_En_5_Chapter_TeX_IEq2.png)
...
IDF(期限)= ![$$ \log \left(\frac{Total\ number\ of\ documents}{Number\ of\ documents\ with\ a\  given\ term\ in\  it}\right) $$](img/434293_2_En_5_Chapter_TeX_IEq3.png)
...
![img/434293_2_En_5_Figb_HTML.jpg](img/434293_2_En_5_Figb_HTML.jpg)
...
![img/434293_2_En_5_Figc_HTML.jpg](img/434293_2_En_5_Figc_HTML.jpg)
...
![img/434293_2_En_5_Figd_HTML.jpg](img/434293_2_En_5_Figd_HTML.jpg)
...
![img/434293_2_En_5_Fige_HTML.jpg](img/434293_2_En_5_Fige_HTML.jpg)
...
欧几里德距离(doc1，doc2) = ![$$ \sqrt{\left(2-3\right)\hat 2+\left(8-7\right)\hat 2}=\sqrt{\left(1+1\right)} $$](img/434293_2_En_5_Chapter_TeX_IEq4.png) = 1.41 = 0

余弦(doc1，doc2) = ![$$ \frac{62}{8.24\ast 7.61} $$](img/434293_2_En_5_Chapter_TeX_IEq5.png) = 0.98，其中
...
||doc1|| = ` ![$$ \sqrt{\left(2\ast 2\right)+\left(8\ast 8\right)} $$](img/434293_2_En_5_Chapter_TeX_IEq6.png) = 8.24

||doc2|| = ![$$ \sqrt{\left(3\ast 3\right)+\left(7\ast 7\right)} $$](img/434293_2_En_5_Chapter_TeX_IEq7.png) = 7.61

同样，让我们找出文档 1 和 3 之间的相似之处(图 5-5 )。

欧几里德距离(doc1，doc3) = ![$$ \sqrt{\left(2-7\right)\hat 2+\left(8-3\right)\hat 2}=\sqrt{\left(25+25\right)}=7.07 $$](img/434293_2_En_5_Chapter_TeX_IEq8.png) = 0

余弦(doc1，doc3)= ![$$ \frac{38}{8.24\ast 7.61} $$](img/434293_2_En_5_Chapter_TeX_IEq9.png) = 0.60

![img/434293_2_En_5_Fig5_HTML.jpg](img/434293_2_En_5_Fig5_HTML.jpg)
...
例如，我们将使用 20 个新闻组数据集，它由 20 个主题的 18，000 多篇新闻组帖子组成。您可以在 [`http://qwone.com/~jason/20Newsgroups/`](http://qwone.com/%257Ejason/20Newsgroups/) 了解更多关于数据集的信息。让我们加载数据并检查主题名称(清单 5-26 )。
...
![img/434293_2_En_5_Fig6_HTML.jpg](img/434293_2_En_5_Fig6_HTML.jpg)
...
![img/434293_2_En_5_Figf_HTML.jpg](img/434293_2_En_5_Figf_HTML.jpg)
...
![img/434293_2_En_5_Fig7_HTML.jpg](img/434293_2_En_5_Fig7_HTML.jpg)
...
![img/434293_2_En_5_Fig8_HTML.jpg](img/434293_2_En_5_Fig8_HTML.jpg)
...
![img/434293_2_En_5_Figg_HTML.jpg](img/434293_2_En_5_Figg_HTML.jpg)
...
![img/434293_2_En_5_Fig9_HTML.jpg](img/434293_2_En_5_Fig9_HTML.jpg)
...
2.  连续跳格模型使用当前单词预测上下文单词的周围窗口，或者给定一个单词，预测在该上下文中可能出现在它附近的其他单词的概率。众所周知，Skip-gram 对常用词和生僻字都有很好的效果。让我们看一个例句，为 2 的窗口创建一个跳转程序(图 5-9 )。用黄色突出显示的单词是输入单词。
...
![img/434293_2_En_5_Fig10_HTML.jpg](img/434293_2_En_5_Fig10_HTML.jpg)
...
![$$ {\hat{x}}_{k,m}=\frac{\sum \limits_{i_b} si{m}_i\left({i}_m,{i}_b\right)\left({x}_{k,b}\right)}{\sum \limits_{i_b}\mid si{m}_i\left({i}_m,{i}_b\right)\mid } $$](img/434293_2_En_5_Chapter_TeX_Equa.png)
...
![$$ p{r}_{x,k}={m}_x+\frac{\sum \limits_{u_y\in {N}_x}\left({r}_{y,k}-{m}_y\right)\kern0.125em \mathrm{sim}\kern0.125em \left({u}_x,{u}_y\right)}{\sum \limits_{u_y\in {N}_x}\mid \mathrm{sim}\kern0.125em \left({u}_x,{u}_y\right)\mid } $$](img/434293_2_En_5_Chapter_TeX_Equb.png)

让我们考虑一个电影评级的示例数据集(图 5-11 )，并应用基于项目和基于用户的推荐来获得更好的理解。清单 5-38 提供了一个推荐系统的示例代码。

![img/434293_2_En_5_Fig11_HTML.jpg](img/434293_2_En_5_Fig11_HTML.jpg)
