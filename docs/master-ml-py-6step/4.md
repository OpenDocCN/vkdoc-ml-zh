...
![img/434293_2_En_4_Figa_HTML.jpg](img/434293_2_En_4_Figa_HTML.jpg)
...
![img/434293_2_En_4_Fig1_HTML.jpg](img/434293_2_En_4_Fig1_HTML.jpg)
...
![img/434293_2_En_4_Fig2_HTML.jpg](img/434293_2_En_4_Fig2_HTML.jpg)
...
![img/434293_2_En_4_Figb_HTML.jpg](img/434293_2_En_4_Figb_HTML.jpg)
...
*   例如，选择正确的模型参数有助于减少偏差和方差。
    ...
    *   For a decision tree, reducing the depth of the decision tree will reduce the variance.
        ...
        ![img/434293_2_En_4_Fig3_HTML.jpg](img/434293_2_En_4_Fig3_HTML.jpg)
...
![img/434293_2_En_4_Fig4_HTML.jpg](img/434293_2_En_4_Fig4_HTML.jpg)
...
![img/434293_2_En_4_Figc_HTML.jpg](img/434293_2_En_4_Figc_HTML.jpg)
...
Bootstrap aggregation(也称为 bagging)由 [Leo Breiman](https://en.wikipedia.org/wiki/Leo_Breiman) 于 1994 年提出；这是一种减少模型方差的模型聚合技术。训练数据被分成多个样本，替换为引导样本。引导样本大小将与原始样本大小相同，原始值的 3/4 和替换导致值的重复(图 4-5 )。

![img/434293_2_En_4_Fig5_HTML.jpg](img/434293_2_En_4_Fig5_HTML.jpg)
...
图 4-6 显示了装袋工艺流程。如果 N 是从原始训练集中创建的引导样本的数量，对于 i = 1 到 N，训练一个基本 ML 模型 C <sub>i</sub> 。

C <sub>最终</sub>= y 的累计最大值![$$ \sum \limits_{\mathrm{i}}\mathrm{I}\left({\mathrm{C}}_{\mathrm{i}}=\mathrm{y}\right) $$](img/434293_2_En_4_Chapter_TeX_IEq1.png)

![img/434293_2_En_4_Fig6_HTML.jpg](img/434293_2_En_4_Fig6_HTML.jpg)
...
![img/434293_2_En_4_Figd_HTML.jpg](img/434293_2_En_4_Figd_HTML.jpg)
...
![img/434293_2_En_4_Fige_HTML.jpg](img/434293_2_En_4_Fige_HTML.jpg)
...
![img/434293_2_En_4_Fig7_HTML.jpg](img/434293_2_En_4_Fig7_HTML.jpg)
...
*   在每次迭代中，将分类器 y <sub>m</sub> (x <sub>n</sub> 拟合到训练数据，并更新权重以最小化加权误差函数。
    ...
    重量计算为![$$ {\mathrm{W}}_{\mathrm{n}}^{\left(\mathrm{m}+1\right)}={\mathrm{W}}_{\mathrm{n}}^{\left(\mathrm{m}\right)}\exp \left\{\ {\propto}_{\mathrm{m}}{\mathrm{y}}_{\mathrm{m}}\ \left({\mathrm{x}}_{\mathrm{n}}\right)\ne {\mathrm{t}}_{\mathrm{n}}\right\} $$](img/434293_2_En_4_Chapter_TeX_IEq2.png)。

    假设权重或损失函数由![$$ {\propto}_{\mathrm{m}}=\frac{1}{2}\log\ \left\{\ \frac{1-{\in}_{\mathrm{m}}}{\in_{\mathrm{m}}}\ \right\} $$](img/434293_2_En_4_Chapter_TeX_IEq3.png)给出，期限利率由![$$ {\in}_{\mathrm{m}}=\kern0.5em \frac{\sum_{\mathrm{n}=1}^{\mathrm{N}}{\mathrm{W}}_{\mathrm{n}}^{\left(\mathrm{m}\right)}\ \mathrm{I}\ \left({\mathrm{y}}_{\mathrm{m}}\left({\mathrm{x}}_{\mathrm{n}}\right)\ne {\mathrm{t}}_{\mathrm{n}}\right)}{\sum_{\mathrm{n}=1}^{\mathrm{N}}{\mathrm{W}}_{\mathrm{n}}^{\left(\mathrm{m}\right)}} $$](img/434293_2_En_4_Chapter_TeX_IEq4.png)给出，其中![$$ \left({\mathrm{y}}_{\mathrm{m}}\left({\mathrm{x}}_{\mathrm{n}}\right)\ne {\mathrm{t}}_{\mathrm{n}}\right)\ \mathrm{has}\ \mathrm{values}\ \frac{0}{1}\ \mathrm{i}.\mathrm{e}.,\kern0.375em 0\ \mathrm{i}\mathrm{f}\ \left({\mathrm{x}}_{\mathrm{n}}\right)\ \mathrm{correctly}\ \mathrm{classified}\ \mathrm{else}\ 1 $$](img/434293_2_En_4_Chapter_TeX_IEq5.png)

*   最终模型由![$$ {\mathrm{Y}}_{\mathrm{m}}=\mathit{\operatorname{sign}}\left(\sum \limits_{\mathrm{m}=1}^{\mathrm{M}}{\propto}_{\mathrm{m}}{\mathrm{y}}_{\mathrm{m}}\left(\mathrm{x}\right)\right) $$](img/434293_2_En_4_Chapter_TeX_IEq6.png)给出

### AdaBoost 的示例图

让我们考虑具有十个数据点的两个类别标签的训练数据。假设，最初，所有数据点将具有由 1/10 给出的相等权重，如图 4-8 所示。

![img/434293_2_En_4_Fig8_HTML.jpg](img/434293_2_En_4_Fig8_HTML.jpg)
...
![img/434293_2_En_4_Fig9_HTML.jpg](img/434293_2_En_4_Fig9_HTML.jpg)
...
![img/434293_2_En_4_Fig10_HTML.jpg](img/434293_2_En_4_Fig10_HTML.jpg)

图 4-10

*Y*<sub>m2</sub>是第二个分类或假设

#### 推进迭代 3

第三分类模型错误分类了总共三个数据点:两个阳性类，P1 和 P2；和一个消极阶层，P9。因此，根据计算，这些错误分类的数据点将被分配一个新的更高的权重 0.19，而其余的数据点将保留其先前的权重(图 4-11 )。

![img/434293_2_En_4_Fig11_HTML.jpg](img/434293_2_En_4_Fig11_HTML.jpg)

图 4-11

*Y*<sub>m3</sub>*是第三种*分类或假设

#### 最终模型

现在，根据 AdaBoost 算法，让我们结合如图 4-12 所示的弱分类模型。注意，最终的组合模型将具有最小的误差项和最大的学习率，从而导致更高的精确度。

![img/434293_2_En_4_Fig12_HTML.jpg](img/434293_2_En_4_Fig12_HTML.jpg)
...
*   迭代地将分类器 y <sub>m</sub> (x <sub>n</sub> 拟合到训练数据。初始模型将具有恒定值![$$ {\mathrm{y}}_0\left(\mathrm{x}\right)=\arg \kern0.375em \min \delta \sum \limits_{\mathrm{i}=1}^{\mathrm{n}}\mathrm{L}\left({\mathrm{y}}_{\mathrm{m}},\delta \right) $$](img/434293_2_En_4_Chapter_TeX_IEq7.png)。

*   计算每个模型拟合迭代 g <sub>m</sub> (x)的损失(即预测值对实际值),或者计算负梯度并使用它来拟合新的基本学习函数 h <sub>m</sub> (x ),并找到最佳梯度下降步长![$$ {\delta}_{\mathrm{m}}=\arg \kern0.375em \min \delta \sum \limits_{\mathrm{i}=1}^{\mathrm{n}}\mathrm{L}\left({\mathrm{y}}_{\mathrm{m}},{\mathrm{y}}_{\mathrm{m}-1}\left(\mathrm{x}\right)+\delta\ {\mathrm{h}}_{\mathrm{m}}\left(\mathrm{x}\right)\ \right) $$](img/434293_2_En_4_Chapter_TeX_IEq8.png)。
...
![img/434293_2_En_4_Figf_HTML.jpg](img/434293_2_En_4_Figf_HTML.jpg)
...
XGBoost 目标函数 obj(θ)=![$$ \sum \limits_{\mathrm{i}}^{\mathrm{n}}\mathrm{l}\left({\mathrm{y}}_{\mathrm{i}}-{\hat{\mathrm{y}}}_{\mathrm{i}}\right)+\sum \limits_{\mathrm{k}=1}^{\mathrm{K}}\varOmega \left({\mathrm{f}}_{\mathrm{k}}\right) $$](img/434293_2_En_4_Chapter_TeX_IEq9.png)

正则项由下式给出

![img/434293_2_En_4_Figg_HTML.jpg](img/434293_2_En_4_Figg_HTML.jpg)
...
![img/434293_2_En_4_Fig13_HTML.jpg](img/434293_2_En_4_Fig13_HTML.jpg)
...
![img/434293_2_En_4_Figh_HTML.jpg](img/434293_2_En_4_Figh_HTML.jpg)
...
![img/434293_2_En_4_Fig14_HTML.jpg](img/434293_2_En_4_Fig14_HTML.jpg)
...
![img/434293_2_En_4_Fig15_HTML.jpg](img/434293_2_En_4_Fig15_HTML.jpg)
...
![img/434293_2_En_4_Fig16_HTML.jpg](img/434293_2_En_4_Fig16_HTML.jpg)
...
![img/434293_2_En_4_Fig17_HTML.jpg](img/434293_2_En_4_Fig17_HTML.jpg)
...
![$$ f(x)=\frac{1}{\sqrt{M}}\ \sum \limits_k{W}_{\phi}\left({j}_0,k\right){\phi}_{j_0,k}(x)+\frac{1}{\sqrt{M}}\ \sum \limits_{j={j}_0}^{\infty}\sum \limits_k{W}_{\psi}\left(j,k\right){\psi}_{j,k}(x) $$](img/434293_2_En_4_Chapter_TeX_IEq10.png)
...
![img/434293_2_En_4_Figi_HTML.jpg](img/434293_2_En_4_Figi_HTML.jpg)
...
Github 知识库
 ...
 |
| --- | --- | --- |
| Scikit-learn | [`http://scikit-learn.org/stable/#`](http://scikit-learn.org/stable/) | [`https://github.com/scikit-learn/scikit-learn`](https://github.com/scikit-learn/scikit-learn) |
| Xgboost | [`https://xgboost.readthedocs.io/en/latest/`](https://xgboost.readthedocs.io/en/latest/) | [`https://github.com/dmlc/xgboost`](https://github.com/dmlc/xgboost) |
| 贝叶斯优化 | 不适用的 | [`https://github.com/fmfn/BayesianOptimization`](https://github.com/fmfn/BayesianOptimization) |
| 小波变换 | [`https://pywavelets.readthedocs.io/en/latest/#`](https://pywavelets.readthedocs.io/en/latest/) | [`https://github.com/PyWavelets/pywt`](https://github.com/PyWavelets/pywt) |
