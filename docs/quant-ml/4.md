...
![$$ \mid {\beta}_{00}\Big\rangle =\frac{1}{\sqrt{2}}\left(|00\Big\rangle +|11\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equj.png)
...
![$$ \rho ={\sum}_{i=1}^n{\rho}_i{p}_i={\sum}_i^n{p}_i\mid {\psi}_i\left\rangle \right\langle {\psi}_i\mid $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equx.png)
...
2.  对于![$$ \mathit{\dim}\left(\mathbf{\mathcal{H}}\right)=N $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_IEq12.png)(希尔伯特空间的维数)，*S*(*ρ*)= log*N*给出了 *S* ( *ρ* )对于*最大混合态*的最大值。
...
![$$ \left|{\psi}_f\Big\rangle =\left(H\otimes I\right){U}_f\left(H\otimes H\right)\right|01\Big\rangle $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equba.png)
...
1.  Evaluate ∣*ψ*<sub>*i*</sub>⟩ by applying Hadamard gates to the input states. By the definition of Hadamard gates, this action produces a product state of superposition. To calculate ∣*ψ*<sub>*i* + 1</sub>⟩, we have the following.
    ...
    ![$$ \mid {\psi}_i\left\rangle =\mid 01\right\rangle $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbb.png)

![$$ \left|{\psi}_{i+1}\Big\rangle =\left(H\otimes H\right)\right|01\Big\rangle =\left[\frac{1}{\sqrt{2}}\left(|0\Big\rangle +|1\Big\rangle \right)\right]\left[\frac{1}{\sqrt{2}}\left(|0\Big\rangle -|1\Big\rangle \right)\right] $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbc.png)

![$$ =\frac{1}{2}\left(|00\Big\rangle -|01\Big\rangle +|10\Big\rangle -|11\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbd.png)

该操作创建一个叠加状态，包含组合的所有可能值( *x* ， *f* ( *x* ))。

1.  In step 2, we apply *U*<sub>*f*</sub> to ∣*ψ*<sub>*i* + 1</sub>⟩ as follows.

    ![$$ \mid {\psi}_{i+2}\left\rangle ={U}_f\mid {\psi}_{i+1}\right\rangle =\frac{1}{2}\left(|0\Big\rangle |f(0)\Big\rangle -|0\Big\rangle |1\oplus f(0)\Big\rangle +|1\Big\rangle |f(1)\Big\rangle -|1\Big\rangle |1\oplus f(1)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Eqube.png)
...
2.  在这一步，我们把我们的分析分成两种情况:当 *f* ( *x* )平衡时和当它恒定时。
    ...
    ![$$ \mid {\psi}_{i+2}\Big\rangle =\frac{1}{2}\left(|0\Big\rangle |f(0)\Big\rangle -|0\Big\rangle |1\oplus f(0)\Big\rangle +|1\Big\rangle |f(0)\Big\rangle -|1\Big\rangle |1\oplus f(0)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbf.png)

![$$ =\frac{1}{2}\left(\left(|0\Big\rangle +|1\Big\rangle \right)\otimes |f(0)\Big\rangle -\left(|0\Big\rangle +|1\Big\rangle \right)\otimes |1\oplus f(0)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbg.png)

![$$ =\frac{1}{2}\Big(\left(|0\Big\rangle +|1\Big\rangle \right)\otimes \left(|f(0)\Big\rangle -|1\oplus f(0)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbh.png)

![$$ =\frac{1}{\sqrt{2}}\mid +\Big\rangle \otimes \left(|f(0)\Big\rangle -|1\oplus f(0)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbi.png)

![$$ \mid +\Big\rangle =\frac{1}{\sqrt{2}}\left(|0\Big\rangle +|1\Big\rangle \right), $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_IEq15.png)老地方，老地方。这意味着量子位现在处于∣+ ⟩态。因此，

![$$ \mid {\psi}_{i+3}\left\rangle =\frac{1}{\sqrt{2}}\mid 0\right\rangle \otimes \left(|f(0)\Big\rangle -|1\oplus f(0)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbj.png)
...
![$$ \mid {\psi}_{i+3}\Big\rangle =\frac{1}{2}\left(|0\Big\rangle |f(0)\Big\rangle -|0\Big\rangle |f(1)\Big\rangle +|1\Big\rangle |f(1)\Big\rangle -|1\Big\rangle |f(0)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbk.png)

![$$ =\frac{1}{2}\left(\left(|0\Big\rangle -|1\Big\rangle \right)\otimes |f(0)\Big\rangle -\left(|0\Big\rangle -|1\Big\rangle \right)\otimes |f(1)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbl.png)

![$$ =\frac{1}{2}\left(|0\Big\rangle -|1\Big\rangle \right)\otimes \left(|f(0)\Big\rangle -|f(1)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbm.png)

![$$ =\frac{1}{\sqrt{2}}\mid -\Big\rangle \otimes \left(|f(0)\Big\rangle -|f(1)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbn.png)

![$$ \mid -\Big\rangle =\frac{1}{\sqrt{2}}\left(|0\Big\rangle -|1\Big\rangle \right), $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_IEq16.png)老地方，老地方。这意味着量子位现在处于∣− ⟩态。因此，

![$$ \mid {\psi}_{i+3}\left\rangle =\frac{1}{\sqrt{2}}\mid 1\right\rangle \otimes \left(|f(0)\Big\rangle -|f(1)\Big\rangle \right) $$](../images/502577_1_En_4_Chapter/502577_1_En_4_Chapter_TeX_Equbo.png)
...
![../images/502577_1_En_4_Chapter/502577_1_En_4_Figv_HTML.jpg](../images/502577_1_En_4_Chapter/502577_1_En_4_Figv_HTML.jpg)
...
![../images/502577_1_En_4_Chapter/502577_1_En_4_Figw_HTML.jpg](../images/502577_1_En_4_Chapter/502577_1_En_4_Figw_HTML.jpg)
...
![../images/502577_1_En_4_Chapter/502577_1_En_4_Fig22_HTML.jpg](../images/502577_1_En_4_Chapter/502577_1_En_4_Fig22_HTML.jpg)
...
![../images/502577_1_En_4_Chapter/502577_1_En_4_Fig23_HTML.jpg](../images/502577_1_En_4_Chapter/502577_1_En_4_Fig23_HTML.jpg)
...
![../images/502577_1_En_4_Chapter/502577_1_En_4_Fig24_HTML.jpg](../images/502577_1_En_4_Chapter/502577_1_En_4_Fig24_HTML.jpg)
