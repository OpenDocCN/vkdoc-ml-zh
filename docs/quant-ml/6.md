...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fig1_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fig1_HTML.jpg)
...
![$$ S\left({\rho}_{12}\right)\le S\left({\rho}_1\right)+S\left({\rho}_2\right) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equa.png)
...
![$$ I\left(A:B\right)\equiv S(1)+S(2)-S(12) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equb.png)

![$$ =S\left({\varphi}_1\right)+S\left({\varphi}_2\right)-S\left({\varphi}_{12}\right) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equc.png)

(6.1)

复合系统的状态空间是组成物理系统的状态的张量积。例如，在纯二分态 A 和 B 中，复合系统的总希尔伯特空间![$$ \mathbf{\mathcal{H}} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq1.png)(见第 [1 章](1.html))变成

![$$ \mid {\left.\psi \right\rangle}_{AB}=\mid {\left.\psi \right\rangle}_A\otimes \mid {\left.\psi \right\rangle}_B\in \mathbf{\mathcal{H}}={\mathbf{\mathcal{H}}}_A\otimes {\mathbf{\mathcal{H}}}_B $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equd.png)

(6.2)

其中，⊗表示张量积。∣*ψ*⟩<sub>T3】abt5】是复合系统的状态向量。如果![$ {\mathbf{\mathcal{H}}}_A $](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq2.png)的维数为 *m* ，而![$ {\mathbf{\mathcal{H}}}_B $](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq3.png)的维数为 *n* ，那么这个总向量就是 *mn* 个基向量的叠加。</sub>

复合状态向量∣ *ψ* ⟩ <sub>*AB*</sub> 的定义表明由*e*<sub>*I*</sub>⊗*v*<sub>*I*</sub>给出的![$$ \mathbf{\mathcal{H}} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq4.png)至少有一个正交基，其中*e*<sub>t22】I</sub>和 *v*

![$$ \mid {\left.\psi \right\rangle}_{AB}=\sum \limits_i^r{a}_i\mid \left.\ {e}_i\right\rangle \otimes \mid \left.\ {v}_i\right\rangle =\sum \limits_i^r{a}_i\mid \left.\ {e}_i\right\rangle \mid \left.\ {v}_i\right\rangle $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Eque.png)

(6.3)

其中， *r* 为*施密特秩，*和*a*T6】T7】IT9】为*施密特基*。在施密特分解的这种表示中，求和指数仅上升到相应的两个希尔伯特空间维度中较小的一个。通过将任意相位吸收到{*e*<sub>*I*</sub>}和{*v*<sub>I</sub>}的定义中，通常可以方便地将幅度 *a* <sub>*i*</sub> 也称为*施密特系数*取为实数。如此，*a*<sub>*I*</sub>≥0 和![$$ \sum \limits_i{a_i}^2=1 $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq7.png)。多体系统中的施密特分解是有限的；只有在两个州才有把握。

作为施密特分解过程的一个例子，我们可以考虑 4 维希尔伯特空间![$$ {\mathbf{\mathcal{H}}}_A\otimes {\mathbf{\mathcal{H}}}_B $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq8.png)中的一个向量，其中![$$ {\mathbf{\mathcal{H}}}_A $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq9.png)和![$$ {\mathbf{\mathcal{H}}}_B $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq10.png)的维数都是 2。这可以由下式给出

![$$ \mid {\left.\psi \right\rangle}_{AB}=\mid \left.11\right\rangle $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equf.png)

对于我们的例子来说，这个状态已经用施密特基写成了，因为对于![$$ {\mathbf{\mathcal{H}}}_A $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq11.png)和![$$ {\mathbf{\mathcal{H}}}_B $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq12.png)中的每一个，计算基都是施密特基。因此，施密特系数如下。

*a* <sub>0</sub> = 0 和 *a* <sub>1</sub> = 1

以下是计算基础。

![$$ \Big\{\mid \left.{\phi}_{A0}\right\rangle =\mid \left.0\right\rangle, \kern2.5em \mid \left.{\phi}_{A1}\right\rangle =\mid \left.1\right\rangle $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equg.png)

![$$ \Big\{\mid \left.{\phi}_{B0}\right\rangle =\mid \left.0\right\rangle, \kern2.5em \mid \left.{\phi}_{B1}\right\rangle =\mid \left.1\right\rangle $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equh.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fig2_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fig2_HTML.jpg)
...
![$$ {\rho}_{AB}={\rho}_A\bigotimes {\rho}_B $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equi.png)
...
![$$ {\rho}_A={Tr}_B\left({\rho}_{AB}\right) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equj.png)
...
![$$ \varphi ={Tr}_B\left(|{\left.\psi \right\rangle}_{AB}{\left\langle \psi \right|}_{AB}\right) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equk.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fig3_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fig3_HTML.jpg)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figa_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figa_HTML.jpg)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figb_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figb_HTML.jpg)
...
![$$ {RZ}_{\theta}\equiv \left(\begin{array}{cc}{e}^{- i\theta /2}&amp; 0\\ {}0&amp; {e}^{i\theta /2}\end{array}\right) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equl.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figc_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figc_HTML.jpg)

下一步，我们计算零概率(即![$$ {\cos}^2\frac{\theta }{2} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq15.png)和相关误差)。这是通过估计以下内容来实现的。

![$$ {\sum}_{x=i}^N\frac{x_i}{N} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equm.png)
...
测量![$$ {\cos}^2\frac{\theta }{2} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq16.png)期间给出的误差由下式给出

![$$ \varepsilon =\Delta {\sum}_{x=i}^N\frac{x_i}{N}\equiv \sqrt{\sum_{x=i}^N\frac{\Delta^2{x}_i}{N}}=\frac{\Delta x}{\sqrt{N}} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equn.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figd_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figd_HTML.jpg)
...
![$$ \mid \left. GHZ\right\rangle =\frac{\mid \left.000\right\rangle +\mid \left.111\right\rangle }{\sqrt{2}} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equo.png)

GHZ 状态是所有处于状态 0 的子系统的量子叠加，所有子系统都处于状态 1，其中单个子系统的状态 0 和 1 是完全可区分的。在清单 [6-1d](#PC4) 中，初始状态为，最终状态由下式给出

![$$ \mid \left.{\psi}_{Final}\right\rangle =\frac{e^{\frac{- iN\theta}{2}}\mid \left.000\right\rangle +{e}^{\frac{iN\theta}{2}}\mid \left.111\right\rangle }{\sqrt{2}} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equp.png)

在我们的例子中，我们有 *N* = 3。因此，测量的概率现在由下式给出

![$$ p(0)={\cos}^2\frac{N\theta}{2} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equq.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fige_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fige_HTML.jpg)
...
![$$ f\left(x;w\right)=\varphi \left({\mathbf{w}}^{\mathbf{T}}.\mathbf{x}\right) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equr.png)

![$$ ={b}_0+{w}_1{x}_1+\dots +{w}_N{x}_N $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equs.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fig4_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fig4_HTML.jpg)

图 6-4

图示线性回归给定训练数据点(*x*<sub>T3】IT5， *y* <sub>*i*</sub> )和非线性映射来拟合相同的数据点</sub>

图 [6-4](#Fig4) 显示了在*左边*给出的训练数据点( *x* <sub>*i*</sub> ， *y* <sub>*i*</sub> )的线性回归示意图。机器学习的任务不是确定拟合本身(与统计分析相反)，而是基于拟合的函数对新输入![$$ \overline{x} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq18.png)的类别标签![$$ \overline{y} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq17.png)进行有根据的猜测。在右侧，图 [6-4](#Fig4) 说明了输入可以通过非线性映射![$$ x\longrightarrow \overline{x} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq19.png)转移到更高维的空间，从而增加线性回归拟合非线性函数的能力。
...
![$$ h(x)={b}_0+{\beta}_1{x}_1+\dots +{\beta}_N{x}_N $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equt.png)
...
![$$ \left\langle {\phi}_x|{\phi}_y\right\rangle =f\left(x;w\right)=\varphi \left({\mathbf{w}}^{\mathbf{T}}.\mathbf{x}\right)=={b}_0+{w}_1{x}_1+\dots +{w}_N{x}_N $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equu.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fig5_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fig5_HTML.jpg)
 ...
 *![img/502577_1_En_6_Chapter/502577_1_En_6_Fig6_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fig6_HTML.jpg)
 ...
 *1.  The Swap Test starts by applying a Hadamard transform to an ancilla qubit that is initially at state ∣0⟩ and the two quantum states ∣*ϕ*<sub>*x*</sub>⟩ and ∣*ϕ*<sub>*y*</sub>⟩ and this leads to the first output state.
    ...
    ![$$ \mid \left.{\psi}_1\right\rangle =H\mid \left.0\right\rangle \mid \left.{\phi}_x\right\rangle \mid \left.{\phi}_y\right\rangle =\frac{1}{\sqrt{2}}\left(|\left.0\right\rangle +|\left.1\right\rangle \right)\mid \left.{\phi}_x\right\rangle \mid \left.{\phi}_y\right\rangle $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equv.png)
...
2.  Next, a C-SWAP gate or Fredkin gate is applied to the two registers ∣*ϕ*<sub>*x*</sub>⟩ and ∣*ϕ*<sub>*y*</sub>⟩. The registers ∣*ϕ*<sub>*x*</sub>⟩ and ∣*ϕ*<sub>*y*</sub>⟩ are conditioned for the ancilla to be in state ∣1⟩. Hence, this operation swaps the states of the two registers: ∣*ϕ*<sub>*x*</sub>⟩ ∣*ϕ*<sub>*y*</sub>⟩ ⟼  ∣*ϕ*<sub>*y*</sub>⟩ ∣*ϕ*<sub>*x*</sub>⟩. At this time, the overall output state is given by
    ...
    ![$$ \mid \left.{\psi}_2\right\rangle =\frac{1}{\sqrt{2}}\left(|\left.0\right\rangle |\left.{\phi}_x\right\rangle |\left.{\phi}_y\right\rangle +|\left.1\right\rangle |\left.{\phi}_y\right\rangle |\left.{\phi}_x\right\rangle \right) $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equw.png)

3.  Then, another Hadamard gate is applied to the ancilla qubit resulting in the following state.

    ![$$ \mid \left.{\psi}_3\right\rangle =\frac{1}{2}\left[\left(|\left.0\right\rangle +|\left.1\right\rangle \right)|\left.{\phi}_x\right\rangle |\left.{\phi}_y\right\rangle +\left(|\left.0\right\rangle -|\left.1\right\rangle \right)|\left.{\phi}_y\right\rangle |\left.{\phi}_x\right\rangle \right] $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equx.png)

![$$ =\frac{1}{2}\left[|\left.0\right\rangle \left(\left|\left.{\phi}_x\right\rangle \right|\left.{\phi}_y\right\rangle +|\left.{\phi}_y\right\rangle |\left.{\phi}_x\right\rangle \right)+|\left.1\right\rangle \left(\left|\left.{\phi}_x\right\rangle \right|\left.{\phi}_y\right\rangle +|\left.{\phi}_y\right\rangle |\left.{\phi}_x\right\rangle \right)\right] $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equy.png)

![$$ =\frac{1}{2}\left[|\left.0\right\rangle \otimes \left(\left|\left.{\phi}_x\right\rangle \right|\left.{\phi}_y\right\rangle +|\left.{\phi}_y\right\rangle |\left.{\phi}_x\right\rangle \right)+|\left.1\right\rangle \otimes \left(\left|\left.{\phi}_x\right\rangle \right|\left.{\phi}_y\right\rangle -|\left.{\phi}_y\right\rangle |\left.{\phi}_x\right\rangle \right)\right] $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equz.png)
...
![$$ {p}_{accept}={\left|\left\langle 0|{\psi}_3\right\rangle \right|}^2=\frac{1}{2}\left[1-{\left|\left\langle {\phi}_x|{\phi}_y\right\rangle \right|}^2\right] $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equaa.png)

(6.10)

这反过来给出了内积的价值

![$$ {\left|\left\langle {\phi}_x|{\phi}_y\right\rangle \right|}^2=1-2{p}_{accept} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equab.png)

或者，

![$$ \left|\left\langle {\phi}_x|{\phi}_y\right\rangle \right|=\sqrt{1-2{p}_{accept}} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equac.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fig7_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fig7_HTML.jpg)
...
![$$ \kappa \longmapsto \upvarphi \times \upvarphi $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equad.png)
...
![$$ \Omega :\varphi \to \vartheta $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equae.png)
...
| 径向基函数 | ![$$ {e}^{-\alpha {\left\Vert {x}_i-{x}_j\right\Vert}^2} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_IEq20.png) |
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figf_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figf_HTML.jpg)
...
![$$ {\Phi}_{TR}=\left\{\left[\begin{array}{c}0\\ {}1\end{array}\right],0,\left[\begin{array}{c}0.78861006\\ {}0.61489363\end{array}\right],1\right\} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equaf.png)

下面是两个测试实例。

![$$ {\Phi}_{Test}=\left\{\left[\begin{array}{c}-0.549\\ {}0.836\end{array}\right],\left[\begin{array}{c}0.053\\ {}0.999\end{array}\right]\right\} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equag.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fig8_HTML.png](img/502577_1_En_6_Chapter/502577_1_En_6_Fig8_HTML.png)
...
![$$ \frac{1}{4N}\sum \limits_{i=0}^1{\left|{x}_t+{x}_i\right|}^2 $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equai.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figg_HTML.png](img/502577_1_En_6_Chapter/502577_1_En_6_Figg_HTML.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figh_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figh_HTML.jpg)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figi_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figi_HTML.jpg)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figj_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figj_HTML.jpg)
...
![$$ {\Phi}_{TR}=\left\{\left[\begin{array}{c}0\\ {}1\end{array}\right],0,\left[\begin{array}{c}\raisebox{1ex}{$\sqrt{2}$}\!\left/ \!\raisebox{-1ex}{$2$}\right.\\ {}\raisebox{1ex}{$\sqrt{2}$}\!\left/ \!\raisebox{-1ex}{$2$}\right.\end{array}\right],1\right\} $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equaj.png)

下面是两个测试实例。

![$$ {\Phi}_{Test}=\left[\begin{array}{c}1\\ {}0\end{array}\right] $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equak.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figk_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figk_HTML.jpg)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figl_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figl_HTML.jpg)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Figm_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Figm_HTML.jpg)
...
![$$ \frac{1}{2\sqrt{2}}\sum \limits_{i=1}^1\left[\mid \left.0\right\rangle \mid \left.i\right\rangle \left(|\left.{x}_t\right\rangle +|\left.{x}_i\right\rangle \right)\mid \left.{y}_i\right\rangle +\mid \left.1\right\rangle \mid \left.i\right\rangle \right(\left|\left.{x}_t\right\rangle -\left|\left.{x}_i\right\rangle \right)\right|\left.{y}_i\right\rangle \Big] $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equal.png)
...
![img/502577_1_En_6_Chapter/502577_1_En_6_Fign_HTML.jpg](img/502577_1_En_6_Chapter/502577_1_En_6_Fign_HTML.jpg)
...
![$$ p(0)={\left|\left\langle 0|\psi \right\rangle \right|}^2=\frac{1}{2}\left[1-{\left|\left\langle x|y\right\rangle \right|}^2\right] $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equam.png)
...
![$$ {\left|x\right|}^{-1}x\mapsto \mid \left.x\right\rangle =\sum \limits_{i=1}^N{\left|x\right|}^{-1}{x}_i\mid \left.i\right\rangle $$](img/502577_1_En_6_Chapter/502577_1_En_6_Chapter_TeX_Equan.png)
