...
![$$ \#\mathrm{parameters}=\#\mathrm{filters}\ast \left(\left(\mathrm{filter}\ \mathrm{height}\ast \mathrm{filter}\ \mathrm{width}\ast \#\mathrm{of}\ \mathrm{filter}\mathrm{s}\ \mathrm{in}\ \mathrm{previous}\ \mathrm{layer}\right)+1\right) $$](img/502243_1_En_6_Chapter_TeX_Equa.png)T2】
