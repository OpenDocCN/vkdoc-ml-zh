...
Figure 5-1 shows the key steps involved with the model at ML-Gates 3 and ML-Gates 2.![img/468661_1_En_5_Fig1_HTML.jpg](img/468661_1_En_5_Fig1_HTML.jpg) Figure 5-1
...
Figure 5-2 shows a screenshot of the RapidMiner main interface.![img/468661_1_En_5_Fig2_HTML.png](img/468661_1_En_5_Fig2_HTML.png) Figure 5-2

RapidMiner 主界面

如图 5-2 所示，RapidMiner 有一个漂亮的现代 GUI。RapidMiner 的易用性使其越来越受欢迎。RapidMiner 拥有一个庞大的用户社区和所有与广泛流行相关的常见支持资源。

RapidMiner 的核心是开源的 Java 代码，可以在 GitHub 的[*【https://github.com/rapidminer/rapidminer-studio】??*下载。](https://github.com/rapidminer/rapidminer-studio)
...
The Weka logo, Figure 5-4, appears during the initialization.![img/468661_1_En_5_Fig4_HTML.jpg](img/468661_1_En_5_Fig4_HTML.jpg) Figure 5-4

保留徽标

After the Weka initialization completes, the main Weka GUI chooser appears, as shown in Figure 5-5.![img/468661_1_En_5_Fig5_HTML.jpg](img/468661_1_En_5_Fig5_HTML.jpg) Figure 5-5
...
Weka is mostly ready to go after the initial install. I will address a few configuration updates next. Figure 5-6 shows the contents of the main Weka directory after you unzip the install file.![img/468661_1_En_5_Fig6_HTML.jpg](img/468661_1_En_5_Fig6_HTML.jpg) Figure 5-6
...
In order to view and modify the contents of the ***weka.jar*** file, you need to unzip the jar file. The 7-Zip utility can unzip jar files. Figure 5-7 shows the 7-Zip utility download page. The download is available at [***www.7-zip.org/download.html***](http://www.7-zip.org/download.html) .![img/468661_1_En_5_Fig7_HTML.jpg](img/468661_1_En_5_Fig7_HTML.jpg) Figure 5-7

7-Zip 解压缩工具

Install the 7-Zip utility on the platform of your choice and then unzip the ***weka.jar*** file. Figure 5-8 shows the contents of the unzipped ***weka.jar***.![img/468661_1_En_5_Fig8_HTML.jpg](img/468661_1_En_5_Fig8_HTML.jpg) Figure 5-8
...
Figure 5-10 shows the local copy of the ***Visualize.props*** file you are updating.![img/468661_1_En_5_Fig10_HTML.jpg](img/468661_1_En_5_Fig10_HTML.jpg) Figure 5-10
...
Figure 5-11 shows the Weka main settings available under the Program menu selection in the Weka GUI Chooser.![img/468661_1_En_5_Fig11_HTML.jpg](img/468661_1_En_5_Fig11_HTML.jpg) Figure 5-11
...
Weka recently introduced a package manager. When you initially run Weka, there are many preinstalled algorithms for clustering and classification. There are also many uninstalled packages that are available for installation with the package manager. Figure 5-12 shows the Weka package manager available from the Weka GUI Chooser.![img/468661_1_En_5_Fig12_HTML.jpg](img/468661_1_En_5_Fig12_HTML.jpg) Figure 5-12
...
Figure 5-14 shows that package manager and highlights the recently installed DBSCAN algorithm. You will use the DBSCAN algorithm in a clustering example later in the chapter.![img/468661_1_En_5_Fig13_HTML.jpg](img/468661_1_En_5_Fig13_HTML.jpg) Figure 5-13

weka 包管理器和 jfreechart 扩展

![img/468661_1_En_5_Fig14_HTML.jpg](img/468661_1_En_5_Fig14_HTML.jpg) Figure 5-14
...
The Explorer is the main Weka interface. Figure 5-15 shows the Weka Explorer upon initialization.![img/468661_1_En_5_Fig15_HTML.jpg](img/468661_1_En_5_Fig15_HTML.jpg) Figure 5-15
...
Figure 5-16 shows these areas highlighted within the Weka ***Classify*** tab.![img/468661_1_En_5_Fig16_HTML.jpg](img/468661_1_En_5_Fig16_HTML.jpg) Figure 5-16
...
The Weka KnowledgeFlow is an alternative graphical front-end to core Weka. KnowledgeFlow implements a dataflow-inspired graphical interface for Weka. Figure 5-17 shows a predefined KnowledgeFlow template opened in Weka KnowledgeFlow. All of the Weka filters, classifiers, clusterers, and data tools are available in the KnowledgeFlow. KnowledgeFlow also includes some extra tools.![img/468661_1_En_5_Fig17_HTML.jpg](img/468661_1_En_5_Fig17_HTML.jpg) Figure 5-17
...
You can adjust the algorithm parameters if you wish to fine-tune the clusters. Notice that some of the data points in the middle area are borderline in determining to which cluster they belong. Figure 5-21 shows adjustments to the DBSCAN algorithm parameters. Some algorithms have many parameters; the DBSCAN algorithm only has two parameters.![img/468661_1_En_5_Fig21_HTML.jpg](img/468661_1_En_5_Fig21_HTML.jpg) Figure 5-21

DBSCAN 算法参数调整

By changing the ***epsilon*** parameter and the ***numPoints*** parameter, you can tighten up the tolerance of the clusters. After changing the parameters, click ***OK*** and then press ***Start*** to commence another clustering. Figure 5-22 shows the new results.![img/468661_1_En_5_Fig22_HTML.jpg](img/468661_1_En_5_Fig22_HTML.jpg) Figure 5-22

更新的 DBSCAN 聚类结果

In this case, the algorithm identified noise in the data. In total, 11 instances fell in the boundary area. Right-click the newest DBSCAN result in the results list to show the new visualization, shown in Figure 5-23.![img/468661_1_En_5_Fig23_HTML.jpg](img/468661_1_En_5_Fig23_HTML.jpg) Figure 5-23
...
图 5-23 显示了加载到 Weka KnowledgeFlow 应用程序中的***cluster-3-CSV-splt . KF***。

Descriptive notes can also be included on the canvas, as shown in Figure 5-25.![img/468661_1_En_5_Fig25_HTML.jpg](img/468661_1_En_5_Fig25_HTML.jpg) Figure 5-25
...
When all of the tasks successfully complete, KnowledgeFlow will mark status as ***OK***, as shown in Figure 5-25. At this point, you can right-click the ***TextViewer*** to show the results. Figure 5-26 shows the ***Result List***.![img/468661_1_En_5_Fig26_HTML.jpg](img/468661_1_En_5_Fig26_HTML.jpg) Figure 5-26
...
表 2-4 显示了原始数据集的结构。数据集附带的**文件记录了这个结构。原始数据集文件很大。它们每个都包含超过 300，000 个实例(行)和 54 个属性(列)。在继续创建模型之前，您需要清理数据。**
...
1.  1.
    ...
    在 Open Office Calc 中打开原来的 ***subject101.dat*** 文件，将 CSV 文件另存为 ***subject101.csv*** 。图 2-5 显示了加载到打开的 Office Calc 电子表格中的数据集。Calc 将原来的***subject 101 . dat***文件转换为逗号分隔的版本，***subject 101 . CSV***。您将清理这个 CSV 文件。
...
因为您导入了 CSV 文件，所以您无法完全控制如何处理属性的数据类型。对于这个数据集，所有的属性都是数字，除了***activity id******，*** 是一个名义值。回想一下表 5-7 ，每个值代表一项活动。要纠正这个问题，您需要使用 Weka ***过滤器*** 将数值 ***ActivityID*** 属性转换为名义数据类型。

Figure 5-27 shows the Weka Explorer after the data import and after the ***ActivityID*** attribute was converted to a nominal data type.![img/468661_1_En_5_Fig27_HTML.jpg](img/468661_1_En_5_Fig27_HTML.jpg) Figure 5-27
...
Each algorithm has its own parameters with which you can experiment. For RF, one of the most important parameters is ***iterations***, which determines how many decision trees the algorithm will use. Figure 5-28 shows the RF algorithm option box.![img/468661_1_En_5_Fig28_HTML.jpg](img/468661_1_En_5_Fig28_HTML.jpg) Figure 5-28

随机森林算法选项

***迭代*** 的默认值为 100。对于您的测试，您将运行四个测试，使用迭代的值 10 和 100，并使用两个测试选项，2/3 分割和 10 倍交叉验证。

Figure 5-29 shows the results of one RF classification with iterations=100 and using the 10-fold cross-validation test option.![img/468661_1_En_5_Fig29_HTML.jpg](img/468661_1_En_5_Fig29_HTML.jpg) Figure 5-29
...
[***www . cs . waikato . AC . NZ/~ ml/publications/1995/cleary 95-kstar . pdf***](http://www.cs.waikato.ac.nz/%257Eml/publications/1995/Cleary95-KStar.pdf)

KStar is available under the ***lazy*** folder when you select ***Choose*** under the classifier section of the Weka Explorer. Figure 5-30 shows the default KStar options.![img/468661_1_En_5_Fig30_HTML.jpg](img/468661_1_En_5_Fig30_HTML.jpg) Figure 5-30
...
![img/468661_1_En_5_Fig32_HTML.jpg](img/468661_1_En_5_Fig32_HTML.jpg) Figure 5-32
...
Figure 5-33 shows the ***Classify-4.kf***  layout including the status window after the flow executes.![img/468661_1_En_5_Fig33_HTML.jpg](img/468661_1_En_5_Fig33_HTML.jpg) Figure 5-33
...
6.  6.
    ...
    点击***ModelPerformanceChart***节点，将渲染器设置为 JFreeChart，如图 5-34 所示。

![img/468661_1_En_5_Fig34_HTML.jpg](img/468661_1_En_5_Fig34_HTML.jpg) Figure 5-34

将渲染器设置为 JFreeChart

Execute the flow and wait for the results to complete. The KNN algorithm will be last due to its long testing times. When everything completes, right-click the ***ImageViewer*** node and show results, as in Figure 5-35.![img/468661_1_En_5_Fig35_HTML.jpg](img/468661_1_En_5_Fig35_HTML.jpg) Figure 5-35
...
Models can be loaded and saved in the Weka Explorer by right-clicking a model in the Weka Explorer ***Results list***. Figure 5-36 shows the ***Save Model*** drop-down dialog box.![img/468661_1_En_5_Fig36_HTML.jpg](img/468661_1_En_5_Fig36_HTML.jpg) Figure 5-36
