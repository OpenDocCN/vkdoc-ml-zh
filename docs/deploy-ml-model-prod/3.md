...
![img/493063_1_En_3_Chapter/493063_1_En_3_Figa_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Figa_HTML.jpg)
...
我们必须设计两个网页，向服务器发送请求并接收响应消息，该响应消息是 ML 模型对特定请求的预测。由于本书并不关注 HTML，你可以简单地使用这些文件，不需要对它们做任何修改，如图 [3-2](#Fig2) 所示。但是对于好奇的读者来说，我们正在创建一个表单来请求五个不同变量中的五个值。我们使用一个带有一些基本字段的标准 CSS 模板。预先了解 HTML 的用户可以根据自己的需求随意重新设计主页。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig2_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig2_HTML.jpg)

图 3-2

输入请求 HTML 表单

下一个模板是向用户发布模型预测。与第一个模板相比，这没有那么复杂，因为只有一个值需要返回给用户，如图 [3-3](#Fig3) 所示。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig3_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig3_HTML.jpg)

图 3-3

模型预测 HTML 表单

让我们继续输入模型预测值，如图 [3-4](#Fig4) 所示。正如我们在图 [3-5](#Fig5) 中所观察到的，模型预测结果是一个连续变量，因为我们已经训练了一个回归模型。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig5_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig5_HTML.jpg)

图 3-5

模型预测法

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig4_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig4_HTML.jpg)
...
一旦我们运行前面的命令，我们将很快看到应用程序启动并在端口 8501 上运行，如图 [3-6](#Fig6) 所示。我们只需点击链接，进入应用程序。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig6_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig6_HTML.jpg)

图 3-6

访问跑步应用

一旦我们到达`http://localhost:8501/`，我们将看到如图 [3-7](#Fig7) 所示的屏幕。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig7_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig7_HTML.jpg)

图 3-7

用户输入页面

如您所见，我们在 UI 中没有任何花哨的东西，但它服务于我们能够在幕后与模型/应用程序交互的总体目的。它类似于我们用 Flask 构建的东西，但是它需要的 HTML 和 CSS 代码要少得多。我们现在可以继续填充值，如图 [3-8](#Fig8) 所示，并获得模型预测。为了便于比较，我们填充了与基于 Flask 的应用程序中相同的值。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig8_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig8_HTML.jpg)

图 3-8

为模型提供输入值

填入数值后，我们需要点击预测按钮来获取模型预测结果和*voilà*——这是我们在基于烧瓶的 app 中得到的相同数字，如图 [3-9](#Fig9) 所示。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig9_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig9_HTML.jpg)
...
![img/493063_1_En_3_Chapter/493063_1_En_3_Figb_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Figb_HTML.jpg)
...
![img/493063_1_En_3_Chapter/493063_1_En_3_Figc_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Figc_HTML.jpg)
...
一旦我们在终端中使用`streamlit run`命令运行`app.py`文件，我们可以看到 web 服务正在本地主机端口 8501 上运行，如图 [3-10](#Fig10) 所示。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig10_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig10_HTML.jpg)
...
让我们在输入框中提供一个评论并检查模型预测，如图 [3-11](#Fig11) 所示。首先，我们提供一个正面评论，并点击预测情绪按钮，如图 [3-12](#Fig12) 所示。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig12_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig12_HTML.jpg)

图 3-12

正面评论预测

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig11_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig11_HTML.jpg)

图 3-11

用户输入页面

正如我们可以观察到的，模型预测的结果似乎是正确的，因为它也预测这是一个积极的评论。我们尝试进行另一项审查——这次是否定的——并测试模型预测，如图 [3-13](#Fig13) 所示。对于第二次审查，我们也通过模型得到了正确的预测。我们可以用一个更强大、训练有素和优化的模型来取代现有的模型，以获得更好的预测。

![img/493063_1_En_3_Chapter/493063_1_En_3_Fig13_HTML.jpg](img/493063_1_En_3_Chapter/493063_1_En_3_Fig13_HTML.jpg)
