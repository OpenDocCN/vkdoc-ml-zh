...
*B*T2】1=![$$ \frac{\sum \left({x}_i-{x}_{mean}\right)\ast \left({y}_i-{y}_{mean}\right)}{\sum {\left({x}_i-{x}_{mean}\right)}^2} $$](img/469852_1_En_4_Chapter_TeX_IEq5.png)
...
*B*T2】1=![$$ \frac{\sum (Covariance)}{\sum \left( Age\ Variance\ Squared\right)} $$](img/469852_1_En_4_Chapter_TeX_IEq6.png)
