...
![$$ Dis{t}_{\left(A,B\right)}=\sqrt{{\left(A1-B1\right)}^2+{\left(A2-B2\right)}^2+{\left(A3-B3\right)}^2+{\left(A4-B4\right)}^2} $$](img/469852_1_En_8_Chapter_TeX_Equa.png)

![$$ Dis{t}_{\left(A,B\right)}=\sqrt{{\left( Age\kern0.5em diff\right)}^2+{\left( Salary\ diff\right)}^2+{\left( Weight\ diff\right)}^2+{\left( Height\ diff\right)}^2} $$](img/469852_1_En_8_Chapter_TeX_Equb.png)

![$$ Dis{t}_{\left(A,B\right)}=\sqrt{{\left(32-40\right)}^2+{\left(8-15\right)}^2+{\left(65-90\right)}^2+{\left(6-5\right)}^2} $$](img/469852_1_En_8_Chapter_TeX_Equc.png)
